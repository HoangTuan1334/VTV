...
def main():
  ...
  api_key = os.getenv("LITELLM_API_KEY", "sk-VWZxoX1d8ZY4cF4eTTyLWQ")
...
**Scene:** A photorealistic, ultra-high-definition (4K) video of a female news anchor in a modern, professional television news studio.

**Visuals:** The anchor is a Vietnamese woman in her 30s, dressed in a smart, professional navy blue blazer and a white blouse. She has a serious yet engaging expression, sitting behind a sleek, polished news desk. In the background, a large digital screen displays the news channel's logo "Bản tin Xanh 24h" and dynamic graphics related to global forest fires, such as a world map with highlighted hotspots. The lighting is professional studio lighting, creating a clean, high-quality broadcast look.

**Action:** The anchor looks directly into the camera, speaking clearly and authoritatively. Her lip movements should be perfectly synchronized with the Vietnamese audio.

**Camera:** The shot is a medium close-up, framing her from the chest up. The camera is static and at eye-level.

**Audio:** The anchor speaks in a clear, professional female voice in Vietnamese. The dialogue is: "Xin kính chào quý vị khán giả! Quý vị đang theo dõi Bản tin Xanh 24h. Hôm nay, chúng ta cùng nhìn lại những diễn biến đáng chú ý về tình hình cháy rừng trong thời gian qua — một vấn đề đang gióng lên hồi chuông cảnh báo toàn cầu.
"
...
A professional Vietnamese female news anchor in a modern TV studio, continuing her report. The background digital screen transitions to a world map with animated fire icons appearing over Vietnam, Canada, and Greece. 4K, hyper-realistic, news broadcast style.
**Audio:** The anchor speaks in a clear, professional female voice in Vietnamese. The dialogue is: "Xin kính chào quý vị khán giả! Quý vị đang theo dõi Bản tin Xanh 24h. Hôm nay, chúng ta cùng nhìn lại những diễn biến đáng chú ý về tình hình cháy rừng trong thời gian qua — một vấn đề đang gióng lên hồi chuông cảnh báo toàn cầu.
"'''
  ],
...
Dramatic, wide-angle aerial drone footage of a massive forest fire in Vietnam's Central Highlands. Thick plumes of smoke rise from lush green mountains being consumed by orange flames. Cinematic, 4K, hyper-realistic.
...
'''
  ...
  example_prompts_3 = [
    ...
    '''**Prompt:**
    A hyper-realistic shot focusing on parched, cracked earth under an intense, hazy sun. The camera pans slowly, showing the extreme heat. 4K, cinematic.
